...
- **FALLBACK**: Install core dependencies manually if Poetry fails:
  - `pip3 install alexapy==1.29.22 packaging wrapt async_timeout aiohttp dictor>=0.1.12,<0.2`
...
- **Core dependencies**: alexapy==1.29.22, aiohttp>=3.8.1, packaging>=20.3, wrapt>=1.12.1, dictor>=0.1.12,<0.2
